  ...
  return joinPromptParts([
    ...
    includeRole
      ? [
          ...
          "- Worker: `apm start <project_id> --agent <codex|claude> --template worker --mode worktree --branch main --slug worker-<task> --custom-prompt \"Implement <task>; update SPECS.md status.\"`",
          "- Reviewer: `apm start <project_id> --agent <codex|claude> --template reviewer --mode worktree --branch main --slug reviewer-<scope> --custom-prompt \"Verify worker output; run tests; report pass/fail against acceptance criteria.\"`",
