...
- Shared protocol schemas live alongside the types: `HistoryEventSchema`, `StreamEventSchema`, `ContainerRunnerProtocolEventSchema`, `ContainerFileOutputRequestSchema`, `ContainerInputSchema`, and `ContainerOutputSchema`.
